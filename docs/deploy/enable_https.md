...
acme.sh --issue -d your-domain.com -d www.your-domain.com -w /srv/developer-portfolio-engine/public # Replace the "your-domain.com" with your actual domain name.
```
