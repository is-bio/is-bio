...
developer-portfolio-engine can also meet the above requirements, yet it is different in a few ways.

## In what ways is developer-portfolio-engine **better** than Jekyll or Hugo?

1. The blog posts generated by Jekyll or Hugo are *static*, while *developer-portfolio-engine* is a **dynamic** blog engine.
    - The functions of *static* blogs are very limited.
    - In *dynamic* blog *developer-portfolio-engine*, email subscriptions are currently integrated, and in the future, resume, portfolio, comments, likes, reading counts, online payments, etc. will also be supported.
...
## developer-portfolio-engine: A blog engine focused on bringing value to developers

- You can see [Zhang Jian's new blog](https://zhangjian.blog) (based on *developer-portfolio-engine*) is well-designed.
...
# Deploy developer-portfolio-engine on a server 

If you want to deploy *developer-portfolio-engine* on a server, please read [deploy_on_CentOS10.md](/docs/deploy/deploy_on_CentOS10.md).

# Install developer-portfolio-engine on your local computer
...
The *developer-portfolio-engine* is developed based on Ruby version 3.3.x, but other versions should also work.
