...
personal-brand-website-builder can also meet the above requirements, yet it is different in a few ways.

## In what ways is personal-brand-website-builder **better** than Jekyll or Hugo?

1. The blog posts generated by Jekyll or Hugo are *static*, while *personal-brand-website-builder* is a **dynamic** blog engine.
    - The functions of *static* blogs are very limited.
    - In *dynamic* blog *personal-brand-website-builder*, email subscriptions are currently integrated, and in the future, resume, portfolio, comments, likes, reading counts, online payments, etc. will also be supported.
...
2. For those who are not familiar with Jekyll or Hugo, it is even **difficult** to even find a good-looking theme.
    - *personal-brand-website-builder* currently supports one **beautiful free theme (8 color options included)**, and more themes will be added in the future.
3. Jekyll or Hugo's documentation is a lot of pages long. Who can explain everything in just one page?
    - *personal-brand-website-builder* can. For information on how to publish a post using *Markdown* and *Git*, please read [markdown-blog](https://github.com/PersonalBranding/markdown-blog) using the *personal-brand-website-builder* approach.
4. A blog post can be translated into multiple languages and displayed on the blog. This feature is currently not supported by any blog engine. However, *personal-brand-website-builder* has already supported it, allowing your articles to reach global users. Eight languages: English, Chinese, Spanish, German, French, Portuguese, Japanese, Russian are already supported by default, and other languages can be easily supported.
...
## What is the cost of using *personal-brand-website-builder*?

Many programmers already use a server, and usually, that server is not fully utilized.

You can install *personal-brand-website-builder* on this server without worrying about port `80/443` being used by another website. In the installation document, I have pointed out how to perfectly solve this problem that does not actually exist.
...
# Deploy personal-brand-website-builder on a server 

If you want to deploy *personal-brand-website-builder* on a server, please read [deploy_on_CentOS10.md](/docs/deploy/deploy_on_CentOS10.md).

# Install personal-brand-website-builder on your local computer
...
The *personal-brand-website-builder* is developed based on Ruby version 3.3.x, but other versions should also work.
...
## Clone 'personal-brand-website-builder' repository and install Ruby gems
...
Please read [markdown-blog](https://github.com/PersonalBranding/markdown-blog) if you are not familiar with how to publish a blog using *Markdown* and *Git*.
