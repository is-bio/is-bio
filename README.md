...
1. The blog posts generated by Jekyll or Hugo are *static*, while *DeveloperPortfolio* is a **dynamic** blog engine.
    ...
    - In *dynamic* blog *DeveloperPortfolio*, email subscriptions are currently integrated, and in the future, portfolios, comments, likes, reading counts, online payments, etc. will also be supported.
...
2. For those who are not familiar with Jekyll or Hugo, it is even **difficult** to even find a good-looking theme.
    - *DeveloperPortfolio* currently supports one **beautiful free theme**, and more themes will be added in the future.
